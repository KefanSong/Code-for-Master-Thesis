...
class FOCOPS:
    ...
    def update_params(self, rollout,rollout2, dtype, device,return_diff, other_group_return,other_group_other_task_return, group_id, task_id):
        ...
        # TO-DO: change to other_group_all_tasks_return[t]
        z = group_id
        ...
        for epoch in range(self.num_epochs):
            ...
            # TO-DO: fetch advb3, adv_b4 from loader
            for _, (obs_b, act_b, vtarg_b, adv_b, adv_b2, cvtarg_b, cadv_b,
                ...
                # TO-DO: calculate adv_b3, 4 and adv_coefficient3, 4, and add it to the policy update.
            ...
            for _ in range(args.rounds_of_update):
                for t in range(num_tasks):
                    ...
                    for z1 in range(num_subgroups):
                        ...
                        # TO-DO: other_group_all_tasks_return
                    ...
                    # TO-DO: send in other group all tasks return as input
