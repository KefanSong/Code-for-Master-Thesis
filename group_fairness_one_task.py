...
class FOCOPS:
    ...
    def __init__(self,
        ...
        if load_model:
            ...
            self.value_net.load_state_dict(logger.models['value_params'])
...
def train(args, env, envname, load_model, cost_lim, group, score_queue, cscore_queue):
    ...
    for iter in range(args.max_iter_num):
        ...
        agent.logger.dump()
    return agent.logger.log_data['AvgR'][-1], agent.score_queue, agent.cscore_queue
...
if __name__ == '__main__':
    ...
    score_queue_list = [deque(maxlen=100), deque(maxlen=100)]
    ...
    for z in range(2):
        ...
        AvgR, score_queue_list[z], cscore_queue_list[z] = train(args, env, envname, False, cost_lim, z, score_queue_list[z], cscore_queue_list[z])
    ...
    for _ in range(1000):
        for z in range(2):
            ...
            AvgR, score_queue_list[z], cscore_queue_list[z] = train(args, env, envname, True, cost_lim, z, score_queue_list[z], cscore_queue_list[z])