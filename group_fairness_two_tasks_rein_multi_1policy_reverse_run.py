...
from models import GaussianPolicy, Value, MultiGaussianPolicy
...
class Agent:
    def __init__(self,env,envname,args,device):
        ...
        # TO-DO: change to multi-gaussian policy. No task_id here.
        
        policy = MultiGaussianPolicy(obs_dim, [act_dim, act_dim], args.hidden_size,args.hidden_size, nn.Tanh, args.logstd)
