...
class FOCOPS:
    ...
    def __init__(self,
        ...
        self.cur_diff = None
        self.epsilon = None
        if cur_diff is not None and epsilon is not None:
    ...
    def update_params(self, rollout, dtype, device):
        ...
        if self.cur_diff is not None and self.epsilon is not None:
            ...
            self.nu += self.nu_lr * (self.epsilon - np.array(self.cur_diff))
            # print("compute")
        else:
        ...
        # if self.cur_diff:
        #     self.logger.update('diff',self.cur_diff)
        print('diff',self.cur_diff)
            # self.nu += self.nu_lr * (self.epsilon  - self.cur_diff)
            # print("compute")
    ...
    for _ in range(1000):
        ...
        for z0 in range(2):
            for z1 in range(2):
                ...
                print('diffz0',diffz0)
                # task 
                AvgR_0,AvgR2_0, score_queue_list[z0], cscore_queue_list[z0] = train(args, env_list, envname, True, cost_lim, z0, score_queue_list[z0], cscore_queue_list[z0],cur_diff=diffz0)
                #-----------
                ...
                print('diffz1',diffz1)
                # task 
                AvgR_1,AvgR2_1, score_queue_list[z1], cscore_queue_list[z1] = train(args, env_list, envname, True, cost_lim, z1, score_queue_list[z1], cscore_queue_list[z1],cur_diff=diffz1)
                #-----------
