...
class CustomHalfCheetahEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        self,
        xml_file="custom_half_cheetah.xml",
        ...
        mujoco_env.MujocoEnv.__init__(self, xml_path, 5, self.observation_space, self.metadata)
