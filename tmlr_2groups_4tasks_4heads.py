...
import time
from data_generator_4groups_4tasks import DataGenerator
...
import wandb
wandb.login()
wandb.init(project="tmlr-1000-2g4t-4heads")
        ...
        for epoch in range(self.num_epochs):
            ...
            for _, (obs_b, act_b, vtarg_b, adv_b, adv_b2, adv_b3, adv_b4, cvtarg_b, cadv_b,
                ...
                if task_id == 0:
                    ...
                    policy_update_term = adv_b3 
                elif task_id ==3:
                    policy_update_term = adv_b4 


                # tmlr only using the first tasks constraint
                policy_update_term += adv_b * (-self.nu[z][0] + self.nu[z][1])
