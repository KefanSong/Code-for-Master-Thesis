...
class DataGenerator:
    ...
    def run_traj(self, env_list, policy, value_net_list, cvalue_net, running_stat,
        ...
        while batch_idx < self.batch_size:
            ...
            for t in range(self.max_eps_len):
                ...
                next_obs2, rew2, _, _, _ = env2.step(act2)
                ...
                if running_stat2 is not None:
                    next_obs2 = running_stat2.normalize(next_obs2)
