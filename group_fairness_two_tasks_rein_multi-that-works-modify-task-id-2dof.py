...
import time
from data_generator_Copy1_Copy1 import DataGenerator
# from models import GaussianPolicy, Value
from models import Value
from models import SingleGaussianPolicy as GaussianPolicy
...
def make_envs(args):
    ...
    for t in range(2):
        ...
        env = gym.wrappers.RecordVideo(env, video_folder='HC_T_2dof'+str(t), episode_trigger= lambda x: x % 50 == 0)
